...
// in restaurant_app/test/mock_api_service.dart.
...
class MockApiService extends _i1.Mock implements _i5.ApiService {
  ...
  @override
  _i6.Future<_i4.RestaurantSearchResponse> getRestaurantSearch(String? query) =>
      (super.noSuchMethod(
            Invocation.method(#getRestaurantSearch, [query]),
  ...
  @override
  _i6.Future<void> addCustomerReview(
    String? id,
    String? name,
    String? review,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#addCustomerReview, [id, name, review]),

...
import 'package:silver_app/model/dicoding_classes.dart';
import 'package:silver_app/utils/sliver_header_delegate.dart';
import 'package:silver_app/widget/list_title_item.dart';
        ...
        slivers: [
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
              (context, index) =>
                  ListTileItem(dicodingClasses: multiplatformPath[index]),
          ...
          SliverGrid(
            delegate: SliverChildBuilderDelegate(
              (context, index) => ListTileItem(dicodingClasses: iosPath[index]),
          ...
          SliverList.builder(
            ...
            itemBuilder:
                (context, index) =>
                    ListTileItem(dicodingClasses: androidPath[index]),
          ),
          ...
          SliverGrid.count(
            ...
            children:
                webPath
                    .map((webClass) => ListTileItem(dicodingClasses: webClass))
                    .toList(),
          ),
        ],
      ),
